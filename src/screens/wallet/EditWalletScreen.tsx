...
export const EditWalletScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  const styles = StyleSheet.create({
    ...
    fieldArrow: {},
    removeText: { color: theme.colors.danger, textAlign: 'center', fontWeight: '700', marginTop: 24 },
    ...
    modalConfirm: { marginTop: 18, backgroundColor: theme.colors.accent, borderRadius: 24, alignItems: 'center', paddingVertical: 14 },
